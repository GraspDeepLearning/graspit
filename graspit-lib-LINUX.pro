...
cgdb {
        graspit_ros {        
                ...
                MODEL_DATABASE_LFLAGS = -L/home/jared/graspit_ros_project/graspit-ros-ws/devel/lib -L/opt/ros/hydro/lib -lhousehold_objects_database -lpostgresql_database -lroscpp
                QMAKE_LFLAGS += $$MODEL_DATABASE_LFLAGS

                LIBS += -lhousehold_objects_database -lpostgresql_database -lroscpp -lrosconsole
